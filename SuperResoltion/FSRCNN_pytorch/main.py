...
parser.add_argument('--batchSize', type=int, default=128, help='训练 batch size')
parser.add_argument('--testBatchSize', type=int, default=128, help='测试 batch size')
parser.add_argument('--nEpochs', type=int, default=1000, help='训练 epochs 数')
